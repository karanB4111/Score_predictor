...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info(f"Catogerical coloumns : {categorical_columns}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            target_featur_train_df = train_df[target_coloumn_name]

            input_feature_test_df = test_df.drop(columns=[target_coloumn_name],axis=1)
            target_featur_test_df = test_df[target_coloumn_name]
            ...
            train_arr = np.c_[input_feature_train_arr,np.array(target_featur_train_df)]
            test_arr = np.c_[input_feature_test_arr,np.array(target_featur_test_df)]

            logging.info("Saved preprossecing object")
